...
Finding the mean of a vector including some missing data (NA) yields NA for the mean as well. This indicates that the presence of missing data in a vector prevents the calculation of a mean for that vector. To calculate a mean, we must somehow exclude NA values from vectors when calculating the mean.
